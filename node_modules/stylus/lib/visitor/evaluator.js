...
Evaluator.prototype.visitImport = function(import_1){
  var found
    , root = this.root
    , stylus = require('../stylus')
    , path = this.visit(import_1.path).first;
  ...
  // Literal
  if (/\.css$/.test(path)) return import_1;
  path += '.styl';
  ...
  // Expose imports
  import_1.path = found;
  import_1.dirname = dirname(found);
  this.paths.push(import_1.dirname);
  if (this.options._imports) this.options._imports.push(import_1);
